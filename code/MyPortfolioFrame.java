...
// implement interfeace
 public class MyPortfolioFrame extends JFrame implements Scrollpane, Home, Aboutme, Project, WorkExperience, Contact {
	...
	/////========================= All IMAGE
		...
		private static final String TEXT3 = "About Me";
		private static final String TEXT4 = "Project History";
		private static final String TEXT5 = "Work Experience";
		private static final String TEXT6 = "Contact";
...
//		private JLabel astronuts;
    ...
    public void addHomePanel() {   
		...
		homescrollpanel.add(lblStudent);
		 typewriteEffect2(lblStudent, TEXT); // effect 
		 ...
		 typewriteEffect2(lblComputerScienceStudent, TEXT2);// effects
    ...
    public void addAboutMePanel() {
	 ...
	 // ============= Mouse listener Hobbies  cardlayout
	   ...
	   // ======================= action listener for Skills card layout
	    ...
	    JLabel lbl6 = new JLabel("experiences for various events. It's an exciting combination of my programming skills");
	    lbl6.setFont(new Font("Anton", Font.PLAIN, 16));
	    lbl6.setBounds(520, 231, 589, 20);
	    aboutmePanel.add(lbl6);
	    
	    JLabel lbl7 = new JLabel("and my passion for creating memorable moments for people.");
   ...
   JLabel textproject1 = new JLabel();
   ...
   typewriteEffect2(textproject1, TEXT4);// effects
   ...
   project1panel.setLayout(null);
    ...
    public void addWorkExperiencePanel() {
	    ...
	    JLabel textworkexperiencelbl = new JLabel();
	    ...
	    typewriteEffect2(textworkexperiencelbl, TEXT5);// effects
    ...
    public void addContactPanel() {
	    ...
	    typewriteEffect2(lblNewLabel_7, TEXT6);// effects
    ...
    // JPANEL NAMING ACTION LISTENER
 	...
 	private static void typewriteEffect2(JLabel label, String text) {
        Timer timer = new Timer(DELAY, null);
        timer.addActionListener(new ActionListener() {
            private int index = 0;
